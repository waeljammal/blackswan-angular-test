...
angular.module('repository-mocks', ['ngMockE2E'])
    .run(function($httpBackend) {
        let data = {
            ...
            'updated_at': '2015-08-19T08:34:55Z',
            'pushed_at': '2015-08-19T09:43:16Z',
            ...
            'network_count': 1269,
            'subscribers_count': 710
        };

        $httpBackend.whenGET('https://api.github.com/repos/angular/angular').respond(200, data);
        $httpBackend.whenGET('https://api.github.com/search/repositories?q=angular').respond(200, {items: [data]});
    });

angular.module('wrapperModule').requires.push('repository-mocks');