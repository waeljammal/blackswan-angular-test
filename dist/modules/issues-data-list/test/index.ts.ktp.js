(function (modules) {
    ...
    function (module, exports, __webpack_require__) {
        (function () {
            var moduleName = 'issuesDataListModule';
            angular.module(moduleName, [])
                .directive('issuesDataList', [__webpack_require__(2)]);
    ...
    function (module, exports, __webpack_require__) {
        ...
        var PanelDataListDirective = (function () {
            function PanelDataListDirective() {
            ...
            PanelDataListDirective = __decorate([
                metadata_1.directive(),
                __metadata('design:paramtypes', [])
            ], PanelDataListDirective);
            return PanelDataListDirective;
        })();
    ...
    function (module, exports) {
        module.exports = "<div class=\"list-group\">\n    <a href=\"\" class=\"list-group-item\"\n       ng-repeat=\"item in data\"\n       ng-class=\"{active: item.id == selectedItem.id}\"\n       ng-click=\"onSelect(item)\">\n        <div class=\"container-hbox\">\n            <img ng-src=\"{{item.user.avatar_url}}\" class=\"img-rounded list-thumb\">\n            <span class=\"container-vbox\">\n                <span><b>{{item.user.login}}</b></span>\n                <span>{{item.title}}</span>\n            </span>\n        </div>\n    </a>\n</div>";
    },
    function (module, exports, __webpack_require__) {
        var map = {
            "./issues-data-list-directive.spec.ts": 12
        };
    ...
    function (module, exports, __webpack_require__) {
        ...
        !function (a, b) { "object" == typeof module && "object" == typeof module.exports ? module.exports = a.document ? b(a, !0) : function (a) { if (!a.document)
            ...
            n.offset = { setOffset: function (a, b, c) { var d, e, f, g, h, i, j, k = n.css(a, "position"), l = n(a), m = {}; "static" === k && (a.style.position = "relative"), h = l.offset(), f = n.css(a, "top"), i = n.css(a, "left"), j = ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1, j ? (d = l.position(), g = d.top, e = d.left) : (g = parseFloat(f) || 0, e = parseFloat(i) || 0), n.isFunction(b) && (b = b.call(a, c, h)), null != b.top && (m.top = b.top - h.top + g), null != b.left && (m.left = b.left - h.left + e), "using" in b ? b.using.call(a, m) : l.css(m); } }, n.fn.extend({ offset: function (a) { if (arguments.length)
                    ...
                    a = a.offsetParent; return a || Ib; }); } }), n.each({ scrollLeft: "pageXOffset", scrollTop: "pageYOffset" }, function (b, c) { var d = "pageYOffset" === c; n.fn[b] = function (e) { return J(this, function (b, e, f) { var g = Jb(b); return void 0 === f ? g ? g[c] : b[e] : void (g ? g.scrollTo(d ? a.pageXOffset : f, d ? f : a.pageYOffset) : b[e] = f); }, b, e, arguments.length, null); }; }), n.each(["top", "left"], function (a, b) { n.cssHooks[b] = ya(k.pixelPosition, function (a, c) { return c ? (c = xa(a, b), va.test(c) ? n(a).position()[b] + "px" : c) : void 0; }); }), n.each({ Height: "height", Width: "width" }, function (a, b) { n.each({ padding: "inner" + a, content: b, "": "outer" + a }, function (c, d) { n.fn[d] = function (d, e) { var f = arguments.length && (c || "boolean" != typeof d), g = c || (d === !0 || e === !0 ? "margin" : "border"); return J(this, function (b, c, d) { var e; return n.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType ? (e = b.documentElement, Math.max(b.body["scroll" + a], e["scroll" + a], b.body["offset" + a], e["offset" + a], e["client" + a])) : void 0 === d ? n.css(b, c, g) : n.style(b, c, d, g); }, b, f ? d : void 0, f, null); }; }); }), n.fn.size = function () { return this.length; }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(14) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () { return n; }.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
    ...
    function (module, exports) {
        ...
        }.call(exports, { "jQuery": true }));
    }
]);
//# sourceMappingURL=index.ts.ktp.js.map